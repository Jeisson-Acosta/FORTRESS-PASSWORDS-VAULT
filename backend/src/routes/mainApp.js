...
mainAppRouter.get('/get-info-vault/:usuid', MainAppController.getInfoVaultOption)
mainAppRouter.get('/get-password/:conid/:usuid', MainAppController.getPasswordApp)